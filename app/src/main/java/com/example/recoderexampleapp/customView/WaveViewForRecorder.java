...
public class WaveViewForRecorder extends View {
    ...
    // constructor
    public WaveViewForRecorder(Context context, AttributeSet attrs) {
    ...
    public void onDraw(Canvas canvas) {
        Log.d("KHOA", "onDraw: "+amplitudes.size());
